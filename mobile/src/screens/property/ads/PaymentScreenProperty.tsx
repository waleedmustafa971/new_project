...
import GooglePay from '../../payment/GooglePay'; // this also added in classified
...
type ClassifiedDetailsRouteProp = RouteProp<
    ...
    'CardPayment'
>;
const PaymentScreenProperty: React.FC = () => {
...
export default PaymentScreenProperty;
