...
const PropertydetailsRecommand = () => {
 ...
 */}
        ...
        <View style={styles.productDetails}>
         ...
         {/*   <Text style={styles.productPrice}>2 Bed, 1080 sqft</Text> 
           <Text style={styles.productPrice}>Holland Gardens, Town Square, Dubai</Text>  */}
        </View>
      </TouchableOpacity>
    );
  };
  ...
  return (
    <View style={{ marginTop: 10 }}>
      ...
      <View style={{ flexDirection: 'row', 
        ...
        <Text style={{ fontSize: 15, fontWeight: 'bold' }}>Similar Properties</Text>
...
export default PropertydetailsRecommand;
