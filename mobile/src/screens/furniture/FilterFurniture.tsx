...
import ShowFurnitureCategory from './ShowFurnitureCategory';
import SearchModalFurniture from './search/SearchModalFurniture';
...
const FilterFurniture: React.FC = () => {
