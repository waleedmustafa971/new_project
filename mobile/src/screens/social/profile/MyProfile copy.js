        ...
        <SafeAreaProvider style={{
            ...
            <ScrollView>
                <View style={styles.profileContainer}>
                    ...
                    >
                        <AntDesign name="right" size={20} color="silver" />
                    </TouchableOpacity>
                </View>
                ...
                <View
                    style={{
                        ...
                        justifyContent: 'center',
                        padding: 8,
                        gap: 12, // React Native doesn't support `space-x-*`, so use horizontal spacing like margin/gap
                    }}
                >
                    <TouchableOpacity
                        style={{
                        ...
                        >
                              <View style={[styles.leftSection, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.optionSubtitle}>Create Post and share with your friends and family</Text>
                                </View>
                            </View>
                            <AntDesign name="right" size={20} color="silver" />
                        </TouchableOpacity>
