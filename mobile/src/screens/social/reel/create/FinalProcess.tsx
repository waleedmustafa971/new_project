...
import {Modal,TextInput,View,Text,TouchableOpacity,Image,ActivityIndicator, Alert} from "react-native";
...
const FinalProcess = ({visible,onClose,onSuccess} : any) => {
  //  console.log('final image file......' + isimagefile + '...image url...' + imageurl)
    ...
    const checkData = async() => {
       ...
       const jsonValue = await AsyncStorage.getItem('userdata');
        ...
        const output = await AsyncStorage.getItem("output");
...
const shareNow = async () => {
  ...
  try {
    const response = await api.post(
      base.BASE_URL + "/apis/reel/update-post-reels",
      {
        videoUrl: output,
        videosound: "yes",
        emojioverlays: [],
        ...
        posttype: "Reel",
        ispost: visibility,
        posttypechild: "Image and text, Audio",
      }
    );
