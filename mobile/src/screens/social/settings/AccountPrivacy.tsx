...
const styles = StyleSheet.create({
  ...
  switchTitle: { fontSize: 15, fontWeight: "600", color: "#111827" },
  switchHint: { fontSize: 12.5, color: "#6B7280", marginTop: 5, lineHeight: 18 },
  linkRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  linkText: { flex: 1, fontSize: 14.5, color: "#1F2937" },
  linkMeta: { fontSize: 13.5, color: "#8A8F98" },
  badge: {
  ...
  pickerTitle: { fontSize: 16, fontWeight: "700", color: "#111827", marginBottom: 8 },
  pickerRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  pickerTextActive: { fontWeight: "600", color: "#111827" },
});
