...
const PaymentItemsSection: React.FC<PaymentItemsSectionProps> = ({ 
  items, total,
  onTotalChange,
  ...
  if (onChangeVoucher) {
   ...
   console.log('...discount...' + JSON.stringify(voucher.discount) + '....subtotal....' + subtotal + '..voucher id ...' + JSON.stringify(voucher))
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        >
          <Text style={styles.voucherText}>
            {selectedVoucher ? "Change Voucher" : "Discount Voucher"}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      {items?.map((item : any) => (
        <View key={item._id} style={styles.itemRow}>
          <Image source={{ uri: base.BASE_URL + base.productpath + item.productId.images?.[0] }} style={styles.image} />
          ...
          <Text style={styles.price}>
            {base.currency} {(item.price * item.qty).toFixed(2)}
          </Text>
        </View>
      ))}
      ...
      <View style={styles.shippingContainer}>
        <Text style={styles.title1}>Shipping Options</Text>
      ...
      <View style={styles.totalContainer}>
        <View style={styles.row}>
          ...
          <Text style={styles.totalValue}>{base.currency} {total.toFixed(2)}</Text>
        </View>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.totalValue}>
             {base.currency} {selectedShipping.cost.toFixed(2)}
          </Text>
        </View>
        ...
        <View style={[styles.row, styles.totalRow]}>
          ...
          <Text
            style={[styles.totalValue, { fontSize: 14, color: Colors.purple }]}
          >
...
export default PaymentItemsSection;

// ✅ keep your existing styles at the end — no change needed
...
const styles = StyleSheet.create({
  ...
  shippingContainer: { marginTop: 25 },
