...
import { welcome,login,register,checkEmail, logout, 
  ...
  checkMobile, registerMobile, verifyMobile,registerMobileModule, 
...
Googlecheck, updateAds, deleteAddress, getProfileid, getStickers,
verifyToken  } from "../controllers/auth.js";
...
//router.post("/reEntryotp",reEntryotp)
router.post("/modulewise_mobile_register", registerMobileModule)
router.post("/update-address", updateAds) //authMiddleware,  
router.post("/delete-address", deleteAddress) //authMiddleware,  delete-address
...
router.get("/stickers", getStickers) //getuser getProfile
router.get("/notInfriends", notInfriends) 
router.get("/suggestions", getSuggestions)
router.get("/getProfile", getProfile)
router.get("/get-userinfo-id", getProfileid)
...
router.post("/updateProfileImageaws", upload.single("images"), updateProfileImageaws) //updateProfileMultiImageaws
