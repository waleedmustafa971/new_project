...
const videoSchema = new mongoose.Schema({
  videoUrl: { type: Object, required: true }, //here will be video URL
...
// Create Model
const PropertyVdieoModal = mongoose.model("propertyvideos", videoSchema);
export default PropertyVdieoModal;
